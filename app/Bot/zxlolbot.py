...
class zxLoLBoT():
    def __init__(self, username, password, region="NA"):
        ...
        self.riot_api_key               = 'f3511a76-4d19-4935-9111-c29cb7459701'
        self.region                     = region
        self.recently_added             = []
        self.friends                    = []
    ...
    def on_xmpp_presence_subscribe(self, presence):
        ...
        self.message(presence["from"], 'Please type anything in order to be verified')
        ...
        """if presence["from"] != self.xmpp.boundjid:
            ...
            if presence["from"] in self.recently_added:
                ...
                if self.someone_online_message:
                    ...
                    #self.message(presence["from"], 'fuck you')"""
    ...
    def on_xmpp_message(self, message):
        ...
        if sender[3:11] in self.friends:
            self.message(sender, "You are verified! Thank you for using LeagueTutor and GLHF!")
            print(sender[3:11])
            self.remove_friend_by_id(sender[3:11])
    ...
    def summoner_id_to_name(self, summoner_id):
        ...
        if self.riot_api_key:
            try:
                source = urllib.request.urlopen("https://na.api.pvp.net/api/lol/"+
